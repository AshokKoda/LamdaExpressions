...
public class ListIteration {
	...
	public static void main(String[] args) {
		...
		System.out.println("----printing list element with consumer obj-----");
		Consumer<Integer> myConsumer = new ConsumerImpl<>();
		li.myList.forEach(myConsumer);

		System.out.println("----printing list element with consumer interface-----");
		...
		System.out.println("----printing list element with sysout-----");
		Consumer<Integer> myConsumer2 = System.out::println;
		li.myList.forEach(myConsumer2);

		System.out.println("-----printing list element with lambda expression---");
